  ...
  MouseMotionListener, ActionListener, ChangeListener
{
  ...
  private JSlider slider, bravity;
...
//    bravity = new JSlider(JSlider.HORIZONTAL, -5, 5, 1); 
//    bravity.addChangeListener(this);
//    bravity.setMajorTickSpacing(1);
//    bravity.setPaintTicks(true);
...
//    frame.getContentPane().add(bravity);
    frame.pack();
